...
class ContentsTest < ApplicationSystemTestCase
  ...
  test "should create content" do
    ...
    fill_in "Data pubblicazione", with: @content.publication_date
    fill_in "Description", with: @content.description
    check "Published" if @content.published
    fill_in "Stato", with: @content.stato
    fill_in "Title", with: @content.title
    fill_in "User", with: @content.user_id
    fill_in "Visibility", with: @content.visibility
  ...
  test "should update Content" do
    ...
    fill_in "Body", with: @content.body
    fill_in "Data pubblicazione", with: @content.publication_date.to_s
    fill_in "Description", with: @content.description
    check "Published" if @content.published
    fill_in "Stato", with: @content.stato
    fill_in "Title", with: @content.title
